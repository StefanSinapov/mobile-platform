 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.obytestest.staging
 */

const BUNDLE_ID = 'com.obytestest'; // ios bundle id
const PACKAGE = 'com.obytestest'; // android package name
const NAME = 'ObytesTest'; // app name
